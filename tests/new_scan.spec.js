...
test('test', async ({ page }) => {
    ...
    //select values
    await page.locator('#ScanNewContactAssistant-ScanImageResultHeaderGroup-Company').getByRole('button', { name: '' }).click();
    await page.locator('fnd-lov-entry').getByText('VENTECHI INC.').click();

    await page.locator('#ScanNewContactAssistant-ScanImageResultHeaderGroup-Name').getByRole('button', { name: '' }).click();
    await page.locator('fnd-lov-entry').getByText('Mike Miller').click();

    await page.locator('#ScanNewContactAssistant-ScanImageResultHeaderGroup-JobTitle').getByRole('button', { name: '' }).click();
    await page.locator('fnd-lov-entry').getByText('CEO').click();

    await page.locator('#ScanNewContactAssistant-ScanImageResultAddressGroup-AddressLine').getByRole('button', { name: '' }).click();
    await page.locator('fnd-lov-entry').getByText('Massachusetts Avenue Northwest').click();

    await page.locator('#ScanNewContactAssistant-ScanImageResultAddressGroup-State').getByRole('button', { name: '' }).click();
    await page.locator('fnd-lov-entry').getByText('DC').click();

    await page.locator('#ScanNewContactAssistant-ScanImageResultAddressGroup-County').getByRole('button', { name: '' }).click();
    await page.locator('fnd-lov-entry div').first().click();

    await page.locator('#ScanNewContactAssistant-ScanImageResultAddressGroup-County').getByRole('button', { name: '' }).click();
    await page.locator('fnd-lov-entry').getByText('District of Columbia').click();


    await page.locator('#ScanNewContactAssistant-ScanImageResultAddressGroup-ZipCode').getByRole('button', { name: '' }).click();
    await page.locator('fnd-lov-entry').getByText('20036').click();

    await page.locator('#ScanNewContactAssistant-ScanImageResultAddressGroup-Country').getByRole('button', { name: '' }).click();
    await page.locator('fnd-lov-entry').getByText('United States').click();

    await page.locator('#ScanNewContactAssistant-ScanImageResultContactGroup-Phone').getByRole('button', { name: '' }).click();
